...
export default function Home() {
  ...
  const runPipelineForFrame = useCallback(
    ...
    [settings.apiKey, settings.model, settings.systemPrompt, settings.geminiKey, settings.unsplashKey, settings.openaiKey, settings.providerType, settings.baseURL, quickMode, pipelinePost, capOversizedSections]
  );
