...
- **"You"** means the individual who is making this Agreement with the Project.
- **"Contribution"** means any source code, documentation, or other original
  work of authorship that you intentionally submit to the Project for inclusion
  in the Project's codebase.
- **"Project Maintainer"** means the individual or entity that maintains the
  Project repository.

### 2. Grant of Copyright License

Subject to the terms and conditions of this Agreement, You hereby grant to the
Project Maintainer and to recipients of software distributed by the Project
...
You agree that the Project Maintainer may relicense Your Contributions under
any license, including but not limited to:

- The GNU Affero General Public License v3 (AGPL-3.0)
- The Elastic License v2 (ELv2)

This right to relicense is essential to the Project's dual-license business
model.

### 5. You Retain Your Copyright

You retain all right, title, and interest in and to Your Contributions. This
Agreement does not transfer ownership of Your Contributions to the Project
Maintainer.

### 6. Original Work

You represent that each of Your Contributions is Your original creation and
that You have the legal right to grant the licenses set forth in this
Agreement.
...
By submitting a pull request or otherwise making a Contribution to the
Project, You agree to the terms of this Agreement.
